    ...
    while (in_creation && *running) {
        ...
        while (SDL_PollEvent(&event)) {
            ...
            if (event.type == SDL_MOUSEBUTTONDOWN) {
                ...
                } else  if (is_point_in_rect(x, y, &button_show_clothes.rect)) {
                    printf("Bouton 'Voir les  vêtement' cliqué !\n");
                    renderer_vet();  // Appel à la fonction pour ajouter un vêtement
                }
            }
        ...
        render_button_c(renderer,font,&button_show_clothes);
