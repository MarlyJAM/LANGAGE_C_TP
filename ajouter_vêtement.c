...
#define FIELD_WIDTH 320    // Largeur des champs (réduit pour s'adapter à la fenêtre)
#define FIELD_HEIGHT 40    // Hauteur des champs
#define FIELD_MARGIN 25    // Espace entre les champs
#define BUTTON_WIDTH 160   // Largeur du bouton
...
// Fonction pour afficher la fenêtre secondaire et gérer l'ajout d'un vêtement
void ajouter_vetement() {
    ...
    TTF_Font *font = TTF_OpenFont("/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf", 18);  // Ajusté la taille de la police
    if (!font) {
    ...
    const char *titles[] = {"Nom", "Categorie", "Température", "Motif", "Type", "Couleur", "Saison", "Image"};
    SDL_Color defaultColor = {255, 0, 0, 255}; // Rouge par défaut
    SDL_Color activeColor = {0, 255, 0, 255};  // Vert si actif
    SDL_Color white = {255, 255, 255, 255};  // Vert si actif
